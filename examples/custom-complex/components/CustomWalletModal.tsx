...
import { StreambirdWalletName } from '@streambird/solana-wallet-adapter'
...
export const CustomWalletModal: FC<CustomWalletModalProps> = ({ className = '', container = 'body' }) => {
    ...
    const getStartedWallet = useMemo(() => {
        return installedWallets.length
            ? installedWallets[0]
            : wallets.find((wallet: { adapter: { name: WalletName } }) => wallet.adapter.name === 'Streambird') ||
    ...
    const handleStart = (e: React.MouseEvent<HTMLButtonElement, globalThis.MouseEvent>) => {
      handleWalletClick(e, StreambirdWalletName)
    }
    ...
    return (
        ...
        createPortal(
            <div
                ...
                role="dialog"
            >
                <div className="wallet-adapter-modal-container-custom">
                            ...
                            <>
                                ...
                                {otherWallets.length ? (
                                    <button
                                        ...
                                        tabIndex={0}
                                    >
                                        <span>Already have a wallet? {expanded ? 'Less ' : 'More '}options</span>
                                        <svg
                                            width="13"
                                            height="7"
                                            viewBox="0 0 13 7"
